...
const ApplicationCard = ({ application, isCandidate = false }) => {
  ...
  const { loading: loadingHiringStatus, fn: fnHiringStatus } = useFetch(updateApplicationsStatus, {
    ...
    <Card>
      ...
      <CardHeader>
        <CardTitle className="flex justify-between font-bold">
          ...
          <Download size={18} className='bg-white text-black rouded-full h-8 w-8 p-1.5 cursor-pointer' onClick={handleDownload}/>
